...
# WARNING: ncurses 6.1 is not working correctly with pasta so we stay with the common 5.X
...
ENTRYPOINT ["pastad", "--p2p-bind-ip=0.0.0.0", "--p2p-bind-port=18080", "--rpc-bind-ip=0.0.0.0", "--rpc-bind-port=18081", "--non-interactive", "--confirm-external-bind"] 
